...
class RecyclerViewAdapter (val context : Context, val restaurants : List<Restaurant>) :RecyclerView.Adapter<RecyclerViewAdapter.RestaurantViewHolder>() {
    ...
    inner class RestaurantViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        val ratingBar = itemView.findViewById<RatingBar>(R.id.restaurantRatingBar)
